...
import { Upload, Download, FileText, Users, Loader2, Eye, FileSpreadsheet, Settings, CheckCircle, Info, Play, Folder, FileCheck2, Sparkles } from "lucide-react";
...
const PayslipGenerator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50" style={{ fontFamily: '"Inter", system-ui, -apple-system, sans-serif' }}>
      {/* Enhanced Header with Warm Color Variation */}
      <div className="bg-gradient-to-r from-slate-50/95 via-blue-50/90 to-indigo-50/95 border-b border-blue-100 shadow-sm backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
              ...
              {processedLogoUrl && (
                <div className="relative">
                  ...
                  <img 
                    ...
                    alt="Company Logo"
                    className="relative w-14 h-14 object-contain rounded-full border-2 border-slate-100 shadow-lg"
                  />
                </div>
              )}
              <div>
            ...
            {processedLogoUrl && (
              <div className="flex items-center space-x-2 bg-gradient-to-r from-emerald-50/90 to-green-50/90 px-4 py-2 rounded-xl border border-emerald-200 shadow-sm">
                <CheckCircle className="w-5 h-5 text-emerald-600" />
                <span className="text-emerald-700 font-medium">Logo Ready</span>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            {/* File Upload Card with Warm Color Variation */}
            <Card className="border border-blue-200 shadow-lg bg-gradient-to-br from-slate-50/95 to-blue-50/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center space-x-3 text-xl text-slate-800">
                  <div className="p-3 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg">
                    <FileSpreadsheet className="w-6 h-6 text-slate-50" />
                  </div>
                  <span>1. Upload Excel File</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="border-2 border-dashed border-blue-300 rounded-xl p-6 hover:border-blue-400 hover:bg-blue-50/60 transition-all duration-300 group bg-slate-50/50">
                  <div className="text-center">
                    ...
                    <Input
                      ...
                      className="mt-4 file:bg-gradient-to-r file:from-blue-500 file:to-blue-600 file:text-slate-50 file:border-0 file:rounded-lg file:px-4 file:py-2 file:mr-4 file:shadow-md hover:file:shadow-lg file:transition-all bg-slate-50/80"
                    />
                  </div>
                </div>
                <div className="flex items-center space-x-2 text-sm text-slate-600 bg-blue-50/70 p-3 rounded-lg">
            ...
            {/* Template Selection Card with Warm Color Variation */}
            <Card className="border border-purple-200 shadow-lg bg-gradient-to-br from-slate-50/95 to-purple-50/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center space-x-3 text-xl text-slate-800">
              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { key: 'classic', name: 'Classic', desc: 'Traditional', gradient: 'from-amber-400 to-orange-500', bg: 'bg-gradient-to-br from-amber-50/90 to-orange-50/80', border: 'border-amber-200' },
                    { key: 'modern', name: 'Modern', desc: 'Recommended', gradient: 'from-blue-400 to-indigo-500', bg: 'bg-gradient-to-br from-blue-50/90 to-indigo-50/80', border: 'border-blue-200' },
                    { key: 'professional', name: 'Professional', desc: 'Corporate', gradient: 'from-slate-400 to-gray-500', bg: 'bg-gradient-to-br from-slate-50/90 to-gray-50/80', border: 'border-slate-200' }
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 text-center transition-all duration-300 transform hover:scale-105 ${
                        selectedTemplate === key 
                          ? `border-blue-400 bg-gradient-to-br from-blue-50/90 to-indigo-50/80 shadow-lg scale-105` 
            ...
            {/* Employee Data Card with Warm Color Variation */}
            {employees.length > 0 && (
              <Card className="border border-emerald-200 shadow-lg bg-gradient-to-br from-slate-50/95 to-emerald-50/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                <CardHeader className="pb-4">
                  <CardTitle className="flex items-center space-x-3 text-xl text-slate-800">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <Button
                      ...
                      className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-slate-50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
                      {isGenerating ? (
                        <>
                    ...
                    {selectedEmployee && (
                      <Button
                        ...
                        variant="outline"
                        className="border-slate-300 hover:bg-gradient-to-r hover:from-slate-50/90 hover:to-gray-50/80 transition-all duration-300 transform hover:scale-105 bg-slate-50/60"
                      >
                  ...
                  {/* Employee List with Warm Color Variation */}
                  <div className="max-h-64 overflow-y-auto border border-slate-200 rounded-xl shadow-inner bg-slate-50/70 backdrop-blur-sm">
                    <table className="w-full text-sm">
                      <thead className="bg-gradient-to-r from-slate-50/95 to-gray-50/90 sticky top-0 backdrop-blur-sm">
                        <tr>
                      ...
                      <tbody>
                        {employees.map((emp, index) => (
                          <tr key={index} className="border-t border-slate-100 hover:bg-gradient-to-r hover:from-blue-50/80 hover:to-indigo-50/70 transition-all duration-200">
                            ...
                            <td className="px-4 py-3">
                              <Button
                                ...
                                disabled={isGenerating}
                                className="text-xs border-blue-200 hover:bg-gradient-to-r hover:from-blue-50/80 hover:to-indigo-50/70 hover:border-blue-300 transition-all duration-200 bg-slate-50/60"
                              >
          ...
          {/* Right Panel - Preview with Warm Color Variation */}
          <div className="space-y-6">
            <Card className="border border-indigo-200 shadow-lg bg-gradient-to-br from-slate-50/95 to-indigo-50/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center space-x-3 text-xl text-slate-800">
                  <div className="p-3 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg">
                    <Eye className="w-6 h-6 text-slate-50" />
                  </div>
                  <span>Preview</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                {selectedEmployee ? (
                  <div className="space-y-4">
                    <div className="bg-gradient-to-br from-slate-50/95 to-gray-50/90 rounded-xl p-5 border border-slate-200 shadow-sm">
      ...
      {/* Template Preview Modal with Warm Color Variation */}
      {showPreview && selectedEmployee && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-50/98 rounded-2xl shadow-2xl max-w-4xl max-h-[90vh] overflow-auto border border-slate-200">
            <div className="flex justify-between items-center p-6 border-b border-slate-200 bg-gradient-to-r from-slate-50/95 to-gray-50/90">
              ...
              <Button 
                ...
                variant="outline"
                size="sm"
                className="hover:bg-slate-100/80 transition-colors bg-slate-50/80"
              >
                Close
              </Button>
            </div>
            <div className="p-6 bg-gradient-to-br from-slate-50/95 to-gray-50/90">
              <div className="transform scale-50 origin-top-left bg-slate-50/95 rounded-lg shadow-lg">
      ...
      {/* PDF Generation Modal with Warm Color Variation */}
      {showPdfTemplate && pdfEmployee && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-slate-50/98 rounded-2xl shadow-2xl max-w-4xl max-h-[90vh] overflow-auto border border-slate-200">
            <div className="text-center p-8 border-b border-slate-200 bg-gradient-to-r from-blue-50/95 to-indigo-50/90">
            ...
            <div ref={payslipRef} className="p-6 bg-gradient-to-br from-slate-50/95 to-gray-50/90">
